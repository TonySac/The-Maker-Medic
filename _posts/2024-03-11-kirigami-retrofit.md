...
![Slicer](/assets/images/3D/Kirigami/kirigami-parts-slicer.png)
...
![Heatset Inserts](/assets/images/3D/Kirigami/kirigami-heatset.png){: .align-right}
...
<figure class="half">
    <img src="/assets/images/3D/Kirigami/kirigami-connectors.png">
    <img src="/assets/images/3D/Kirigami/kirigami-led.png">
</figure>
...
![Completed Mount](/assets/images/3D/Kirigami/kirigami-mounted.png)

## Step 3: Removing the Stock Bed Assembly

:bangbang: Before proceeding, make sure the printer is turned off and has been unplugged from power for several minutes. The following steps involve disassembling parts of the printer and exposing the electronics.
{: .notice--danger}

To make these steps easier, I suggest starting by removing the tophat, side, rear, and bottom panels.

![Naked Voron](/assets/images/3D/Kirigami/naked-voron0.png){: .align-left}
...
:warning: Be careful when removing the rails to prevent the carriages from sliding off. I suggest using stoppers or zip ties to hold the carriages on the rails as they are removed.
{: .notice--warning}

![Stock Bed & Rails](/assets/images/3D/Kirigami/kirigami-stock-rails.png){: .align-right}
...
:bulb: Take advantage of having the rails off and make sure they are cleaned and well lubricated.
{: .notice--success}
...
![SKR](/assets/images/3D/Kirigami/SKR.png){: .align-right}
...
![Bare Rails](/assets/images/3D/Kirigami/bare-rails.png){: .align-right}
...
![Bed](/assets/images/3D/Kirigami/installed-bed.png){: .align-right}
...
![Chain](/assets/images/3D/Kirigami/chain-wires.png){: .align-left}
...
![Wire Routing](/assets/images/3D/Kirigami/kirigami-mounted.png){: .align-right}
...
![Bed Wiring](/assets/images/3D/Kirigami/bed-wires.png){: .align-right}
...
:bangbang: Powering up the printer with exposed electronics increase the risk of electric shock or damage to components.
{: .notice--danger}
...
![Complete Install](/assets/images/3D/Kirigami/completed.png)
